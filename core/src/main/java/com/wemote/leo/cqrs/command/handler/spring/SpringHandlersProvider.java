 ...
 */
package com.wemote.leo.cqrs.command.handler.spring;

import com.wemote.leo.cqrs.command.handler.CommandHandler;
import com.wemote.leo.cqrs.command.impl.RunEnvironment.HandlersProvider;
...
public class SpringHandlersProvider implements HandlersProvider, ApplicationListener<ContextRefreshedEvent> {
    ...
    private Map<Class<?>, String> handlers = Maps.newHashMap();
