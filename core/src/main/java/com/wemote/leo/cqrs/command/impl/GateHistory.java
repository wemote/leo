 ...
 * <br>
 * Each command class has it's own entries in history - history length can be parameter parameterized via constructor parameter.
 *
...
class GateHistory {
    ...
    private Map<Class, CommandExecutionsMap> history = Maps.newConcurrentMap();
    ...
    public boolean register(Object command) {
        ...
        long millisFromLastRun = now.getTime() - lastRun.getTime();
        return millisFromLastRun > uniqueStorageTimeout;
    }
